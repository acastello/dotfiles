...
syn match hsStatement		"\<\(do\|case\|of\|let\|in\|rec\)\>"
...
" Type declarations
" syn region  hsTypeDec keepend  start="::" end="^[a-zA-Z]\+" contains=hsTypeVar,hsInfix
" syn match   hsTypeVar "\<[a-z][a-zA-Z0-9_']*\>" contained
...
hi def link hsModule			  Namespace
hi def link hsImport			  Import
...
hi def link hsTypeVar			  Identifier
