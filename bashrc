...
bind '"\e\C-f\e-.":     "\\*/.\\*\e[C\e[C -iname \e\C-f"'
...
bind '"\e\C-k\C-d":         "delete pod \C-a \C-e"'
...
bind '"\e\C-g=":          "add \e\C-g\e="'
bind '"\e\C-g\e=":          abort'
bind '"\e\C-g\e=p":         "-p \e\C-g\e="'
bind '"\e\C-g\e=\r":        ".\n"'
...
alias aurman='aurman --noconfirm --needed'
...
alias hub-pr='hub pull-request -d --no-edit | tee >(xclip)'
